...
function preload() {
  zombie1 = loadImage("./assets/assets/zombie1.png");
  zombie2 = loadImage("./assets/assets/zombie2.png");

  zombie3 = loadImage("./assets/assets/zombie3.png");
  zombie4 = loadImage("./assets/assets/zombie4.png");

  backgroundImage = loadImage("./assets/assets/background.png");
}
